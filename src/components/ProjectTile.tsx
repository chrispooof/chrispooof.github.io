  ...
  return (
    <>
      {projects.map(({ link, projectName, description, language }) => (
        <a key={projectName} href={link} target="_blank" rel="noopener noreferrer" className="no-underline">
          <div className="relative inline-grid bg-[#f5f6ff] rounded-xl shadow-md w-48 h-48 p-6 mx-6 mt-12 mb-6 text-center transition-all duration-500">
